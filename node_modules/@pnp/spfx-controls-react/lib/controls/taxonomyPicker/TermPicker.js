...
var TermPicker = (function (_super) {
    ...
    function TermPicker(props) {
        ...
        _this.termsService = new SPTermStorePickerService_1.default(_this.props.termPickerHostProps, _this.props.context);
        return _this;
    }
    /**
    ...
    TermPicker.prototype.onRenderItem = function (term) {
        return (React.createElement("div", { className: TaxonomyPicker_module_scss_1.default.pickedTermRoot, key: term.index, "data-selection-index": term.index, "data-is-focusable": !term.disabled && true },
            React.createElement("span", { className: TaxonomyPicker_module_scss_1.default.pickedTermText }, term.item.name),
            !term.disabled && (React.createElement("span", { className: TaxonomyPicker_module_scss_1.default.pickedTermCloseIcon, onClick: term.onRemoveItem },
    ...
    TermPicker.prototype.onRenderSuggestionsItem = function (term) {
        ...
        return (React.createElement("div", { className: TaxonomyPicker_module_scss_1.default.termSuggestion, title: termTitle },
            React.createElement("div", null, term.name),
            React.createElement("div", { className: TaxonomyPicker_module_scss_1.default.termSuggestionSubTitle },
                " ",
    ...
    TermPicker.prototype.onFilterChanged = function (filterText, tagList) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, termPickerHostProps, context_1, isTermSetSelectable, terms, termSet, filteredTerms, _b, disabledTermIds_1, disableChildrenOfDisabledParents, _loop_1, this_1, _i, terms_1, term;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        if (!(filterText !== "")) return [3 /*break*/, 8];
                        _a = this.props, termPickerHostProps = _a.termPickerHostProps, context_1 = _a.context, isTermSetSelectable = _a.isTermSetSelectable;
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    ...
                                    case 1:
                                        ...
                                        return [4 /*yield*/, this_1.termsService.getAllTerms(this_1.props.termPickerHostProps.termsetNameOrID)];
                                    case 2:
                                        this_1.allTerms = _a.sent();
                                        _a.label = 3;
                                    case 3:
