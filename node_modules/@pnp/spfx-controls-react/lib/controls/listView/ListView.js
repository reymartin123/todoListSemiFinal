...
var ListView_DragDrop_module_scss_1 = require("./ListView.DragDrop.module.scss");
...
var ListView = (function (_super) {
    ...
    ListView.prototype.componentWillUnmount = function () {
        var dragDropFiles = this.props.dragDropFiles;
        if (dragDropFiles) {
            var divDropArea = this.dropArea;
    ...
    ListView.prototype._processProperties = function () {
        var _a = this.props, dragDropFiles = _a.dragDropFiles, items = _a.items, iconFieldName = _a.iconFieldName, viewFields = _a.viewFields, groupByFields = _a.groupByFields, showFilter = _a.showFilter;
    ...
    ListView.prototype.render = function () {
        var groupProps = {};
        var _a = this.props, showFilter = _a.showFilter, filterPlaceHolder = _a.filterPlaceHolder, dragDropFiles = _a.dragDropFiles;
        var _b = this.state, filterValue = _b.filterValue, items = _b.items, dragStatus = _b.dragStatus;
        ...
        return (React.createElement("div", { className: ListView_DragDrop_module_scss_1.default.DragDropArea, ref: this.dropRef },
            (dragStatus && dragDropFiles) &&
                React.createElement("div", { className: ListView_DragDrop_module_scss_1.default.DragDropAreaBorder },
                    React.createElement("div", { className: ListView_DragDrop_module_scss_1.default.DragDropAreaZone },
                        React.createElement(Icon_1.Icon, { iconName: "Download", className: "ms-IconExample" }),
                        React.createElement("div", null, strings.UploadFileHeader))),
