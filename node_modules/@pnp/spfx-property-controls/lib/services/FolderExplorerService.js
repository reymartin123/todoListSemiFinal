...
var FolderExplorerService = (function () {
        ...
        this._getDocumentLibraries = function (webAbsoluteUrl) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        web = new sp_1.Web(webAbsoluteUrl);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        web = new sp_1.Web(webAbsoluteUrl);
                        return [4 /*yield*/, web.getFolderByServerRelativeUrl(folderRelativeUrl).folders.select('Name', 'ServerRelativeUrl').orderBy('Name').get()];
                    case 2:
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        web = new sp_1.Web(webAbsoluteUrl);
                        return [4 /*yield*/, web.getFolderByServerRelativeUrl(folderRelativeUrl).folders.add(name)];
                    case 2:
    ...
    FolderExplorerService.serviceKey = sp_core_library_1.ServiceKey.create('SPFx:SPService', FolderExplorerService);
