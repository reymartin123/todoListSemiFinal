 ...
 */
var MAXRESULTS = 100;
var FilesSearchService = (function () {
    function FilesSearchService(context, bingAPIKey) {
        ...
        this.checkFileExists = function (fileUrl) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 2, , 3]);
                        return [4 /*yield*/, this.context.httpClient.fetch(fileUrl, sp_http_1.SPHttpClient.configurations.v1, {
                                headers: new Headers(),
                                method: 'HEAD',
                                mode: 'cors'
                            })];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.context.spHttpClient.post(searchApi, sp_http_1.SPHttpClient.configurations.v1, {
                                headers: {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.context.httpClient.get(apiUrl, sp_http_1.SPHttpClient.configurations.v1, {
                                headers: headers,
                                method: 'GET',
                                mode: 'cors'
                            })];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, GeneralHelper_1.GeneralHelper.getFileFromBlob(blob, fileName)];
                    case 3:
                        err_4 = _a.sent();
        ...
        this.downloadBingContent = function (absoluteFileUrl, fileName) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        return [4 /*yield*/, this.context.httpClient.get(absoluteFileUrl, sp_http_1.SPHttpClient.configurations.v1, {
                                method: "GET",
                                mode: "cors"
                            })];
                    case 1:
        ...
        this.parseRecentSearchResult = function (cells) {
            var titleCell = Utilities_1.find(cells, function (x) { return x.Key === "Title"; });
            var keyCell = Utilities_1.find(cells, function (x) { return x.Key === "UniqueID"; });
            var fileUrlCell = Utilities_1.find(cells, function (x) { return x.Key === "DefaultEncodingURL"; });
            var editedByCell = Utilities_1.find(cells, function (x) { return x.Key === "ModifiedBy"; });
            var recentFile = {
...
exports.FilesSearchService = FilesSearchService;
