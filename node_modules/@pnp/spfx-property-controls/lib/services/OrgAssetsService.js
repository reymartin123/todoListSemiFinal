...
var FileBrowserService_1 = require("./FileBrowserService");
var sp_http_1 = require("@microsoft/sp-http");
var OrgAssetsService = (function (_super) {
    ...
    function OrgAssetsService(context, itemsToDownloadCount) {
            ...
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            _a.trys.push([0, 3, , 4]);
                            restApi = this.context.pageContext.web.absoluteUrl + "/_api/Microsoft.Online.SharePoint.TenantManagement.Office365Tenant/GetOrgAssets";
                        ...
                        case 2:
                            ...
                            libs = orgAssetsData ? orgAssetsData.OrgAssetsLibraries.Items.map(function (libItem) { return _this._parseOrgAssetsLibraryItem(libItem); }) : [];
        ...
        _this._parseOrgAssetsLibraryItem = function (libItem) {
            var orgAssetsLibrary = {
                ...
                iconPath: libItem.ThumbnailUrl.DecodedUrl ? _this.buildAbsoluteUrl(_this._orgAssetsLibraryServerRelativeSiteUrl + "/" + libItem.ThumbnailUrl.DecodedUrl) : null
            };
...
}(FileBrowserService_1.FileBrowserService));
exports.OrgAssetsService = OrgAssetsService;
