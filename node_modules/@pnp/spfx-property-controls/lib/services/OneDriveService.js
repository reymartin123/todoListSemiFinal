...
var OneDriveService = (function (_super) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.context.spHttpClient.get(fileUrl, sp_http_1.SPHttpClient.configurations.v1)];
                    case 1:
                    ...
                    case 2:
                        ...
                        return [4 /*yield*/, this.context.httpClient.get(oneDrvieFileUrl, sp_http_1.SPHttpClient.configurations.v1, {
                                headers: new Headers(),
                                method: 'GET',
                                mode: 'cors'
                            })];
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this.context.spHttpClient.get(apiUrl, sp_http_1.SPHttpClient.configurations.v1, {
                                headers: {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.context.spHttpClient.post(userProfileApi, sp_http_1.SPHttpClient.configurations.v1, {})];
                    case 1:
