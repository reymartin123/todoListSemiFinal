    ...
    CollectionDataItem.prototype.renderField = function (field, item) {
        ...
        switch (field.type) {
            ...
            case __1.CustomCollectionFieldType.dropdown:
                var dropdownOptions = (typeof (field.options) === "function") ?
                    field.options(field.id, item) :
                    field.options;
                return React.createElement(Dropdown_1.Dropdown, { placeHolder: field.placeholder || field.title, options: dropdownOptions, selectedKey: item[field.id] || null, required: field.required, disabled: disableFieldOnEdit, onChanged: function (opt) { return _this.onValueChanged(field.id, opt.key); }, onRenderOption: field.onRenderOption, className: "PropertyFieldCollectionData__panel__dropdown-field" });
