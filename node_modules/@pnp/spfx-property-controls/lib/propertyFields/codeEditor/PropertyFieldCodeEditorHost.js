...
var IPropertyFieldCodeEditor_1 = require("./IPropertyFieldCodeEditor");
var Label_1 = require("office-ui-fabric-react/lib/Label");
var TextField_1 = require("office-ui-fabric-react/lib/TextField");
var CodeFormatter_1 = require("./CodeFormatter");
...
var PropertyFieldCodeEditorHost = (function (_super) {
    ...
    PropertyFieldCodeEditorHost.prototype.onFormatCode = function () {
        var formattedCode;
        var codeFormatter = new CodeFormatter_1.CodeFormatter();
            ...
            React.createElement(Panel_1.Panel, { isOpen: this.state.openPanel, hasCloseButton: true, onDismiss: this.onClosePanel, isLightDismiss: true, type: Panel_1.PanelType.medium, headerText: this.props.panelTitle, onRenderFooterContent: function () { return (React.createElement("div", { className: PropertyFieldCodeEditorHost_module_scss_1.default.actions },
                    React.createElement("div", { className: "ms-Grid", dir: "ltr" },
                        React.createElement("div", { className: "ms-Grid-row" },
                            ...
                            _this.props.language !== IPropertyFieldCodeEditor_1.PropertyFieldCodeEditorLanguages["Plain Text"] &&
                                React.createElement(Button_1.DefaultButton, { color: "ms-bgColor-themeLight", iconProps: { iconName: 'ClearFormatting' }, text: strings.FormatCodeButtonLabel, value: strings.ExportButtonLabel, onClick: _this.onFormatCode }))))); } },
