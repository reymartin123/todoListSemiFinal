...
var placeHolderControl_1 = require("../../placeHolderControl");
...
var RecentFilesTab = (function (_super) {
    ...
    function RecentFilesTab(props) {
        ...
        _this._onSelectionChanged = function () {
            ...
            if (selectedItems && selectedItems.length > 0) {
                ...
                var filePickerResult = {
                    ...
                    fileName: GeneralHelper_1.GeneralHelper.getFileNameFromUrl(selectedKey_1.fileUrl),
                    fileNameWithoutExtension: GeneralHelper_1.GeneralHelper.getFileNameWithoutExtension(selectedKey_1.fileUrl),
                    downloadFileContent: function () { return _this.props.fileSearchService.downloadSPFileContent(selectedKey_1.fileUrl, GeneralHelper_1.GeneralHelper.getFileNameFromUrl(selectedKey_1.fileUrl)); }
                };
        ...
        _this._renderPlaceholder = function () {
            return React.createElement(placeHolderControl_1.Placeholder, { iconName: 'OpenFolderHorizontal', iconText: strings.NoRecentFiles, description: strings.NoRecentFilesDescription });
        };
        /**
