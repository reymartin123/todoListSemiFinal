        ...
        _this._itemSelectionChanged = function (item) {
            ...
            if (selectedItem && !selectedItem.isFolder) {
                filePickerResult = {
                    ...
                    fileName: GeneralHelper_1.GeneralHelper.getFileNameFromUrl(selectedItem.name),
                    fileNameWithoutExtension: GeneralHelper_1.GeneralHelper.getFileNameWithoutExtension(selectedItem.name),
        ...
        var columns = [
            {
                ...
                onRender: function (item) {
                    ...
                    var isPhoto = GeneralHelper_1.GeneralHelper.isImage(item.name);
            ...
            },
            {
                ...
                onColumnClick: _this._onColumnClick,
                onRender: function (item) {
                    return React.createElement("span", null, item.fileSize ? GeneralHelper_1.GeneralHelper.formatBytes(item.fileSize, 1) : undefined);
                }
            }
        ];
