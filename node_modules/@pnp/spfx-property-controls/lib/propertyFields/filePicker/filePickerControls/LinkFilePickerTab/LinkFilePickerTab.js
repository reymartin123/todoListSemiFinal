    ...
    function LinkFilePickerTab(props) {
        ...
        _this._handleChange = function (fileUrl) {
            var filePickerResult = fileUrl && _this._isUrl(fileUrl) ? {
                ...
                downloadFileContent: function () { return _this.props.fileSearchService.downloadBingContent(fileUrl, GeneralHelper_1.GeneralHelper.getFileNameFromUrl(fileUrl)); }
            } : null;
            _this.setState({
        ...
        _this._isSameDomain = function (fileUrl) {
            ...
            return GeneralHelper_1.GeneralHelper.getAbsoluteDomainUrl(siteUrl) === GeneralHelper_1.GeneralHelper.getAbsoluteDomainUrl(fileUrl);
        };
