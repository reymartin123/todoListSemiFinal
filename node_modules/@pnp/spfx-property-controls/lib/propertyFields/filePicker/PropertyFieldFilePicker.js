...
var PropertyFieldFilePickerHost_1 = require("./PropertyFieldFilePickerHost");
/**
 * Represents a PropertyFieldFilePicker object
 */
var PropertyFieldFilePickerBuilder = (function () {
    function PropertyFieldFilePickerBuilder(_targetProperty, _properties) {
        ...
        this.render = function (elem, ctx, changeCallback) {
            var element = React.createElement(PropertyFieldFilePickerHost_1.default, {
                label: _this.label,
 ...
 */
function PropertyFieldFilePicker(targetProperty, properties) {
...
exports.PropertyFieldFilePicker = PropertyFieldFilePicker;
